...
public class ExecutorExamples {
    ...
    public static void demonstrateFixedThreadPool() throws InterruptedException {
        System.out.println("1. Fixed Thread Pool Example:");
        System.out.println("   Creating pool with 3 threads to handle 10 tasks");
        System.out.println("   Notice how only 3 threads are used (pool-1-thread-1, 2, 3)\n");
        
        // Create thread pool with exactly 3 threads
        ...
        System.out.println("OBSERVE: Only 3 threads handled all 10 tasks by reusing threads.");
    }
